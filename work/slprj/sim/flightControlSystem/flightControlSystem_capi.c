...
static int_T rt_LoggedStateIdxList [ ] = { 10 , 26 , 27 , 29 , 32 , 36 , 7 ,
16 , 33 , 21 , 20 , 19 , 43 , 8 , 14 , 9 , 15 , 25 , 13 , 17 , 18 , 35 , 23 ,
22 , 31 , 30 , 28 , 24 , 34 } ;
...
0 } } ; static int_T rtContextSystems [ 33 ] ; static rtwCAPI_LoggingMetaInfo
loggingMetaInfo [ ] = { { 0 , 0 , "" , 0 } } ; static
rtwCAPI_ModelMapLoggingStaticInfo mmiStaticInfoLogging = { 33 ,
...
{ 3094016706U , 3183795983U , 3368557064U , 758768898U } , &
...
= ( sysRanDType * ) & dqykr4eggmg . otjykwnhb3s . idn2v5d33m ; systemRan [ 15
] = ( sysRanDType * ) & dqykr4eggmg . otjykwnhb3s . mgysgsd2g4 ; systemRan [
16 ] = ( NULL ) ; systemRan [ 17 ] = ( sysRanDType * ) & dqykr4eggmg .
otjykwnhb3s . phrpuocqmvu . mkkaskumzr ; systemRan [ 18 ] = ( sysRanDType * )
& dqykr4eggmg . otjykwnhb3s . ifzbhw4mrws . ley0an2uip ; systemRan [ 19 ] = (
NULL ) ; systemRan [ 20 ] = ( sysRanDType * ) & dqykr4eggmg . otjykwnhb3s .
bm3dpymkhz . mkkaskumzr ; systemRan [ 21 ] = ( sysRanDType * ) & dqykr4eggmg
. otjykwnhb3s . ipbtas1tys . ley0an2uip ; systemRan [ 22 ] = ( NULL ) ;
systemRan [ 23 ] = ( sysRanDType * ) & dqykr4eggmg . otjykwnhb3s . a1oodzfxvv
; systemRan [ 24 ] = ( NULL ) ; systemRan [ 25 ] = ( sysRanDType * ) &
dqykr4eggmg . otjykwnhb3s . mfifybuxty ; systemRan [ 26 ] = ( sysRanDType * )
& dqykr4eggmg . otjykwnhb3s . klyrn0mwhb ; systemRan [ 27 ] = ( NULL ) ;
systemRan [ 28 ] = ( NULL ) ; systemRan [ 29 ] = ( NULL ) ; systemRan [ 30 ]
...
systemTid [ 11 ] = nmtwkzsqud [ 0 ] ; systemTid [ 7 ] = nmtwkzsqud [ 0 ] ;
systemTid [ 10 ] = nmtwkzsqud [ 0 ] ; systemTid [ 8 ] = nmtwkzsqud [ 0 ] ;
systemTid [ 9 ] = nmtwkzsqud [ 0 ] ; systemTid [ 12 ] = nmtwkzsqud [ 0 ] ;
...
systemTid [ 20 ] = nmtwkzsqud [ 0 ] ; systemTid [ 18 ] = nmtwkzsqud [ 0 ] ;
...
systemTid [ 27 ] = nmtwkzsqud [ 0 ] ; systemTid [ 28 ] = nmtwkzsqud [ 0 ] ;
systemTid [ 29 ] = nmtwkzsqud [ 1 ] ; systemTid [ 30 ] = nmtwkzsqud [ 1 ] ;
systemTid [ 31 ] = nmtwkzsqud [ 1 ] ; systemTid [ 32 ] = nmtwkzsqud [ 0 ] ;
...
[ 11 ] = 11 ; rtContextSystems [ 12 ] = 0 ; rtContextSystems [ 13 ] = 0 ;
rtContextSystems [ 14 ] = 14 ; rtContextSystems [ 15 ] = 15 ;
rtContextSystems [ 16 ] = 0 ; rtContextSystems [ 17 ] = 17 ; rtContextSystems
[ 18 ] = 18 ; rtContextSystems [ 19 ] = 0 ; rtContextSystems [ 20 ] = 20 ;
rtContextSystems [ 21 ] = 21 ; rtContextSystems [ 22 ] = 0 ; rtContextSystems
[ 23 ] = 23 ; rtContextSystems [ 24 ] = 0 ; rtContextSystems [ 25 ] = 25 ;
rtContextSystems [ 26 ] = 26 ; rtContextSystems [ 27 ] = 0 ; rtContextSystems
[ 28 ] = 0 ; rtContextSystems [ 29 ] = 0 ; rtContextSystems [ 30 ] = 0 ;
rtContextSystems [ 31 ] = 0 ; rtContextSystems [ 32 ] = 0 ; }
#endif
#ifndef HOST_CAPI_BUILD
