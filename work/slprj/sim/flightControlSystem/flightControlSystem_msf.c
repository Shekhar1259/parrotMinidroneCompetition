...
#endif
static void mdlInitializeConditions ( SimStruct * S ) { uint8_T * o_o_B_25_2
= ( uint8_T * ) ssGetOutputPortSignal ( S , 1 ) ; ha1ipjbq54 ( o_o_B_25_2 ) ;
...
o_B_25_1 = ( real32_T * ) ssGetOutputPortSignal ( S , 0 ) ; uint8_T *
o_o_B_25_2 = ( uint8_T * ) ssGetOutputPortSignal ( S , 1 ) ; if ( tid == 0 )
{ flightControlSystemTID0 ( i_bdony3ptwc , o_B_25_1 , o_o_B_25_2 ) ;
...
false ) ; ssRegisterMsgForNotSupportingMultiExecInst ( S ,
 "<diag_root><diag id=\"Simulink:blocks:LoggingBlockDoesNotSupportMultiExecInstancesWithCustomMsg\" pr=\"d\"><arguments><arg type=\"encoded\">ZgBsAGkAZwBoAHQAQwBvAG4AdAByAG8AbABTAHkAcwB0AGUAbQAvAEMAbwBuAHQAcgBvAGwAIABTAHkAcwB0AGUAbQAvAFQAbwAgAFcAbwByAGsAcwBwAGEAYwBlAAAA</arg><arg type=\"encoded\">PABfAF8AaQBpAFMAUwBfAF8APgA8AC8AXwBfAGkAaQBTAFMAXwBfAD4AAAA=</arg><arg type=\"encoded\">PABfAF8AaQB0AGUAcgBCAGwAawBfAF8APgA8AC8AXwBfAGkAdABlAHIAQgBsAGsAXwBfAD4AAAA=</arg></arguments><hs><h>AAAAEADYp0AA</h></hs><causes><diag id=\"Simulink:logLoadBlocks:ToWksBlkMultiExecInsNoSupportMsg\" pr=\"d\"><msg encoded=\"yes\"></msg></diag></causes></diag></diag_root>"
...
i_bdony3ptwc = ( SensorsBus * ) ssGetInputPortSignal ( S , 1 ) ; real32_T *
o_B_25_1 = ( real32_T * ) ssGetOutputPortSignal ( S , 0 ) ; uint8_T *
o_o_B_25_2 = ( uint8_T * ) ssGetOutputPortSignal ( S , 1 ) ; if ( tid ==
PARAMETER_TUNING_TID ) { flightControlSystemTID2 ( ) ; } if ( tid !=
CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { if ( ssIsSampleHit ( S , 0 ,
tid ) ) { flightControlSystemTID0 ( i_bdony3ptwc , o_B_25_1 , o_o_B_25_2 ) ;
